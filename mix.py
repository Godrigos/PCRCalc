...
def mix(self):
    ...
    mgcl2_lab_val = Label(frame, text=f" {round(self.final_mix['MgCl₂'], 3)} ", width=6, anchor=E)
    ...
    h2o_lab_val = Label(frame, text=f" {round(self.final_mix['H₂O'], 3)} ", width=6, anchor=E)
    ...
    dna_lab = Label(frame, text=f"Add {round(dna_add, 3)} \u03bcL of stock DNA to each reaction!", justify=CENTER,
                    anchor=CENTER, wraplength=140)
