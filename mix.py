...
def mix(self):
    ...
    if h2o < 0:
        ...
        buf_lab_val = Label(frame, text=f" {round(self.final_mix['Buffer'], 3)} ", width=7, anchor=E)
        ...
        dntps_lab_val = Label(frame, text=f" {round(self.final_mix['DNTPs'], 3)} ", width=7, anchor=E)
        ...
        mgcl2_lab_val = Label(frame, text=f" {round(self.final_mix['MgCl2'], 3)} ", width=7, anchor=E)
        ...
        p1_lab_val = Label(frame, text=f" {round(self.final_mix['Primer 1'], 3)} ", width=7, anchor=E)
        ...
        p2_lab_val = Label(frame, text=f" {round(self.final_mix['Primer 2'], 3)} ", width=7, anchor=E)
        ...
        if self.final_mix['Primer 3'] != 0:
            ...
            p3_lab_val = Label(frame, text=f" {round(self.final_mix['Primer 3'], 3)} ", width=7, anchor=E)
        ...
        if self.final_mix['Primer 4'] != 0:
            ...
            p4_lab_val = Label(frame, text=f" {round(self.final_mix['Primer 4'], 3)} ", width=7, anchor=E)
        ...
        taq_lab_val = Label(frame, text=f" {round(self.final_mix['Taq'], 3)} ", width=7, anchor=E)
        ...
        if self.final_mix['Glycerol'] != 0:
            ...
            gly_lab_val = Label(frame, text=f" {round(self.final_mix['Glycerol'], 3)} ", width=7, anchor=E)
        ...
        if self.final_mix['DMSO'] != 0:
            ...
            dmso_lab_val = Label(frame, text=f" {round(self.final_mix['DMSO'], 3)} ", width=7, anchor=E)
        ...
        h2o_lab_val = Label(frame, text=f" {round(self.final_mix['H2O'], 3)} ", width=7, anchor=E)
        ...
        total_lab_val = Label(frame, text=f" {round(self.final_mix['Mix Total'], 3)} ", width=7, anchor=E)
